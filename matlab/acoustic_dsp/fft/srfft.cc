...
void SplitRadixComplexFft<Real>::ComputeRecursive(Real *xr, Real *xi, MatrixIndexT logm) const {
  ...
  Real    *cn = nullptr, *spcn = nullptr, *smcn = nullptr, *c3n = nullptr, *spc3n = nullptr, *smc3n = nullptr;
  Real    tmp1, tmp2;
