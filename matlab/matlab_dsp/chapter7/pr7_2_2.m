...
for i=1:M                    % 计算基波和各阶谐波的参数
    if i==1                  % 若计算基波,在40-60Hz区间中寻找最大峰值
        ...
        n1=fix((i*ff(1)-10)/df);      % 求出区间对应的索引号
        n2=fix((i*ff(1)+10)/df);
    end
...
% 海宁窗的beta对alpha的表示式
    a=-0.985782+2.871279*b-2.481274*b^2+1.747132*b^3-0.91095*b^4+...
        0.320022*b^5-0.066571*b^6+0.0061436*b^7; 
...
% 按式(7-2-9)依海宁窗的窗函数关系计算出谐波的幅值
    A(i)=yk*(3.999998+2.580052*(gama)^2+0.989796*(gama)^4+...
        0.352636*(gama)^6)/N; 
